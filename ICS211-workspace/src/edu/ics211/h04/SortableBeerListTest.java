...
public class SortableBeerListTest {
  ...
  public void testIndexOf() {
    ...
    assertEquals("Should find pils0", bitters.indexOf(pils[0]), 0);
    assertEquals("Should find pils1", bitters.indexOf(pils[1]), 1);
    assertEquals("Should find pils2", bitters.indexOf(pils[2]), 2);
  }
